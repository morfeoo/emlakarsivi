...
{
    public abstract class EmlakTakipWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EmlakTakipWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EmlakTakipWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EmlakTakipDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EmlakTakipDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EmlakTakipDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EmlakTakipDbContext, Task<T>> func)
        {
            T result;
