...
namespace RemDijital.EmlakTakip.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly EmlakTakipDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = EmlakTakipConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(EmlakTakipDbContext context)
        {
            _context = context;
        }
