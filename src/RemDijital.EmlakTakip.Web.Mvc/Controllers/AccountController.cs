...
using RemDijital.EmlakTakip.Sessions;
using RemDijital.EmlakTakip.Web.Models.Account;
using RemDijital.EmlakTakip.Web.Views.Shared.Components.TenantChange;

namespace RemDijital.EmlakTakip.Web.Controllers
{
    public class AccountController : EmlakTakipControllerBase
    {
